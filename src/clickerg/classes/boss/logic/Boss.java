...
import clickerg.classes.boss.persistence.readBossFileBoss;
import clickerg.classes.boss.persistence.readBossFileAccountInfo;
import clickerg.classes.boss.persistence.readBossItemFileAccountInfo;
import clickerg.classes.boss.persistence.readBossFileItem;
import clickerg.classes.boss.persistence.writeBossFileAccountInfo;
...
public class Boss implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            Class.forName("clickerg.classes.boss.logic.KindredBoss");
            Class.forName("clickerg.classes.boss.logic.SylvanasBoss");
            Class.forName("clickerg.classes.boss.logic.MacarraBoss");
